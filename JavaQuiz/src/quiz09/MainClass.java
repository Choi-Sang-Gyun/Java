...
//		User user2 = new User("홍길동", 123123, 20);
//		System.out.println(user2);
//		System.out.println(user2.getName());
//		System.out.println(user2.getRrn());
//		System.out.println(user2.getAge());
		...
		User[] arr = new User[2];
		User user3 = new User("김길동", 456456, 30);
		
		arr[0] = user2;
		arr[1] = user3;
		
		for(User a : arr) {
			System.out.println(a.getName() + " " + a.getRrn() + " " + a.getAge());
		}
