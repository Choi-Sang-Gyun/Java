...
//		Student s3 = new Student("소능민", 40, "123");
//	
//		Teacher t1 = new Teacher("강호동", 40, "체육");
//		Teacher t2 = new Teacher("뉴재석", 50, "국어");
//		
...
//		Employee[] employees = {e1};		
		...
		Person s3 = new Student("소능민", 40, "123");
	
		Person t1 = new Teacher("강호동", 40, "체육");
		Person t2 = new Teacher("뉴재석", 50, "국어");
		...
		for(Person p : persons) {
			...
			System.out.println(p.info()); //오버라이드 메서드 실행
